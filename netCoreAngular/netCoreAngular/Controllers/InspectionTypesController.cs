...
namespace netCoreAngular.Controllers
{
    ...
    public class InspectionTypesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<InspectionType>>> GetInsepectionTypes()
        {
            return await _context.InsepectionTypes.ToListAsync();
        }
        ...
        {
            var inspectionType = await _context.InsepectionTypes.FindAsync(id);
        ...
        {
            _context.InsepectionTypes.Add(inspectionType);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteInspectionType(int id)
        {
            ...
            _context.InsepectionTypes.Remove(inspectionType);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.InsepectionTypes.Any(e => e.Id == id);
        }
    }
}
